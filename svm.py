...
inpRaster = r"D:\svm\Input\Image\1.tif"
outRaster = r"D:\svm\Output\SVM.tif"
out_prob = r"D:\svm\Output\Probability_Map.tif"
...
shapefile = r"D:\svm\Input\Shapefile\Training_site.shp"
shapefile_test = r"D:\svm\Input\Shapefile\testing.shp"
rasterized_shp = r"D:\svm\Output\Rasterized.tif"
rasterized_shp_test = r"D:\svm\Output\Rasterized_test.tif"
...
df.to_csv('D:\svm\Output\CM.csv', index=False)
...
df_test.to_csv('D:\svm\Output\CM_test.csv', index=False)
...
img = plt.imread('D:\svm\Output\SVM.tif')
plt.imshow(img)
plt.show()
